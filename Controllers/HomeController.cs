...
namespace WebApp_OpenIDConnect_DotNet.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        // Must grant admin consent for these permissions by clicking Grant admin consent for Default Directory.
        // According to https://docs.microsoft.com/en-us/azure/storage/common/storage-auth-aad-app?tabs=dotnet
        ...
        public async Task<IActionResult> Blob()
        {
            ...
            Uri blobUri = new Uri("https://account.blob.core.windows.net/test/Blob1.txt");
